          ...
          <div className="flex w-full gap-8 ">
            <div className="flex w-full">
              {showCheckout ? (
                ...
                <div className=" mx-auto max-w-[1440px] justify-center flex flex-col px-[11.111vw] md:px-0 ">
                  <img src="/src/assets/Images/bag_1_80158fc33b.png" className="w-15 self-center"/>
                  <div className="text-base md:text-lg lg:text-xl mt-12 text-center font-medium leading-xs text-black xl:text-xl select-none md:select-text">Your Bag Feels Too Light!</div>
                  <div className="text-sm md:text-base w-80 lg:text-lg font-normal mt-3 text-center leading-xxl text-neutral-600 xl:text-base select-none md:select-text">Looks like your bag is empty. Fill it with things that make you feel stylish.</div>
                  <Link to={"/category"}>
                  <button className="inline-flex items-center justify-center whitespace-nowrap text-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none bg-black shadow text-white px-4 py-2 font-medium rounded-sm gap-0  mt-10 h-10  md:h-12 md:w-full ">
                    ...
                    {cartItems.map((item) => (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-col w-full justify-between md:flex-col md:gap-0 lg:flex-row lg:gap-12 sm:gap-12 sm:flex-row">
                  ...
                  <div>
                    ...
                    <div className="xs:border-1 border-x xs:border-divider">
                      ...
                      <div className="flex items-center justify-between px-4 py-1 md:px-6">
                        ...
                        <div className="text-xs font-medium">₹{totalPrice}</div>
                      </div>
